...
namespace SCG.CHEM.MBR.DATAACCESS.Migrations
{
    ...
    [Migration("20221122042849_add_fct_marketpriceolefin")]
    partial class add_fct_marketpriceolefin
    {
            ...
            modelBuilder.Entity("SCG.CHEM.MBR.DATAACCESS.Entities.Master.MBR_FCT_MARKETPRICEOLEFINS", b =>
                {
                    ...
                    b.Property<decimal>("ProductWeb")
                        .HasColumnType("decimal(18,2)")
                        .HasColumnName("PRODUCT_WEB");

                    b.Property<decimal>("SubScenario")
                        .HasColumnType("decimal(18,2)")
                    ...
                    b.HasKey("Scenario", "PricingYear", "PricingMonth", "PricingWeekNo", "PricingWeek");
            ...
            modelBuilder.Entity("SCG.CHEM.MBR.DATAACCESS.Entities.Master.MBR_MST_CUSTOMER_VENDOR_MAPPING", b =>
                {
                    ...
                    b.HasIndex("CustomerCode", "VersionNo")
                        .IsUnique();
            ...
            modelBuilder.Entity("SCG.CHEM.MBR.DATAACCESS.Entities.Master.MBR_MST_PRODUCT_MAPPING", b =>
                {
                    ...
                    b.HasIndex("ProductShortName", "VersionNo")
                        .IsUnique();
