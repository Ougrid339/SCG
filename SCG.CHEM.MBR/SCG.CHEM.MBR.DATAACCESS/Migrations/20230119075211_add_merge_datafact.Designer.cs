...
namespace SCG.CHEM.MBR.DATAACCESS.Migrations
{
    ...
    [Migration("20230119075211_add_merge_datafact")]
    partial class add_merge_datafact
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SCG.CHEM.MBR.DATAACCESS.Entities.Master.MBR_MST_ASSUMPTION", b =>
                {
                    ...
                    b.HasKey("Type", "PlanType", "Cycle", "Case", "VersionNo");

                    b.ToTable("MBR_MST_Assumption", "mbr");
                });
            ...
            modelBuilder.Entity("SCG.CHEM.MBR.DATAACCESS.Entities.Temp.MBR_TMP_ASSUMPTION", b =>
                {
                    b.Property<string>("Type")
                        .HasMaxLength(100)
                        .HasColumnType("nvarchar(100)");
                    ...
                    b.HasKey("Type", "PlanType", "Cycle", "Case", "VersionNo", "RunId");

                    b.ToTable("MBR_TMP_Assumption", "mbr");
                });
            ...
            modelBuilder.Entity("SCG.CHEM.MBR.DATAACCESS.Entities.Temp.MBR_TMP_BEGINING_INVENTORY", b =>
                {
                    ...
                    b.HasKey("Case", "PlanType", "Cycle", "ProductShortName", "MonthNo", "MCSC", "RunId", "MaterialCode", "SupplierKey");
            ...
            modelBuilder.Entity("SCG.CHEM.MBR.DATAACCESS.Entities.Temp.MBR_TMP_SALES_PREVIEW_SUBMIT", b =>
                {
                    b.Property<Guid>("WebUUID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                        .HasColumnName("WebUUID");
                    ...
                    b.Property<string>("PriviewRunId")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("PriviewRunId");

                    b.Property<string>("SubmitRunId")
                        .HasColumnType("nvarchar(max)")
                        .HasColumnName("SubmitRunId");

                    b.Property<string>("UpdateFinalPriceRunId")
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)")
                        .HasColumnName("UpdateFinalPriceRunId");
                    ...
                    b.ToTable("MBR_TMP_SalesPreviewSubmit", "mbr");
                });
            ...
            modelBuilder.Entity("SCG.CHEM.MBR.DATAACCESS.Entities.Temp.MRB_TMP_FEED_INFO", b =>
                {
                    ...
                    b.Property<string>("ContractSpot")
                        .IsRequired()
                        .HasMaxLength(10)
                        .HasColumnType("nvarchar(10)")
                        .HasColumnName("ContractSpot");
                    ...
                    b.Property<decimal?>("InsuranceUSDPerTon")
                        .HasColumnType("decimal(15,5)");
                    ...
                    b.Property<decimal?>("SurveyorUSDPerTon")
                        .HasColumnType("decimal(15,5)");
            ...
            modelBuilder.Entity("SCG.CHEM.MBR.DATAACCESS.Entities.Transaction.MBR_TRN_BEGINING_INVENTORY", b =>
                {
                    ...
                    b.HasKey("Case", "PlanType", "Cycle", "ProductShortName", "MonthNo", "MCSC", "MaterialCode", "SupplierKey");
            ...
            modelBuilder.Entity("SCG.CHEM.MBR.DATAACCESS.Entities.Transaction.MBR_TRN_MERGE_HISTORY", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("MBR_TRN_MergeHistory", "mbr");
                });
