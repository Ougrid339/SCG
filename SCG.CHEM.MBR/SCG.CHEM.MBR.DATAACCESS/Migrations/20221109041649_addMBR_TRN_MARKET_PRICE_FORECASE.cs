...
{
    public partial class addMBR_TRN_MARKET_PRICE_FORECASE : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MBR_TRN_MarketPriceForcase", x => new { x.CASE, x.SCENARIO, x.MARKET_SOURCE, x.CYCLE });
                });
        }
