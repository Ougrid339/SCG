...
{
    public partial class dropMarketPriceForcase : Migration
    {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Cycle = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MBR_TRN_MarketPriceForcase", x => new { x.CaseId, x.ScenarioId, x.MARKET_SOURCE, x.Cycle });
                });
        }
    }
}
