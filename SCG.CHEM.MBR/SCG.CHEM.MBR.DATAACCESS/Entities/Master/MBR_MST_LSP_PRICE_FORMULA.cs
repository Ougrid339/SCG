...
namespace SCG.CHEM.MBR.DATAACCESS.Entities.Master
{
    ...
    public class MBR_MST_LSP_PRICE_FORMULA : BaseMasterContext
    {
        [StringLength(40)]
        ...
        public MBR_MST_LSP_PRICE_FORMULA()
        { }

        public MBR_MST_LSP_PRICE_FORMULA(MBR_TMP_LSP_PRICE_FORMULA data)
        {
        ...
        public MBR_MST_LSP_PRICE_FORMULA(string productCode, string productShortName, string productDescription
