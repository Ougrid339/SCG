...
namespace SCG.CHEM.MBR.DATAACCESS.Entities.Master
{
    ...
    public class MBR_MST_MARKET_PRICE_MAPPING : BaseMasterContext
    {
        [StringLength(50)]
        ...
        public MBR_MST_MARKET_PRICE_MAPPING()
        { }

        public MBR_MST_MARKET_PRICE_MAPPING(MBR_TMP_MARKET_PRICE_MAPPING data)
        {
        ...
        public MBR_MST_MARKET_PRICE_MAPPING(string marketPriceShortName, string marketPriceMI, string marketPriceWebPricing
