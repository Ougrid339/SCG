...
namespace SCG.CHEM.MBR.DATAACCESS.Entities.Temp
{
    ...
    public class MBR_TMP_CUSTOMER_VENDOR_MAPPING : BaseMasterContext
    {
        [Key]
        [StringLength(50)]
        ...
        public MBR_TMP_CUSTOMER_VENDOR_MAPPING()
        { }

        public MBR_TMP_CUSTOMER_VENDOR_MAPPING(MBR_MST_CUSTOMER_VENDOR_MAPPING data)
        {
        ...
        public MBR_TMP_CUSTOMER_VENDOR_MAPPING(string customerShortName, string type, string customerCode, string sourceSystem, int versionNo)
        {
