...
namespace SCG.CHEM.MBR.DATAACCESS.Entities.Temp
{
    ...
    public class MBR_TMP_PRODUCT_MAPPING : BaseMasterContext
    {
        //[Key]
        [StringLength(50)]
        ...
        public MBR_TMP_PRODUCT_MAPPING()
        { }

        public MBR_TMP_PRODUCT_MAPPING(MBR_MST_PRODUCT_MAPPING data)
        {
        ...
        public MBR_TMP_PRODUCT_MAPPING(string productShortName, string materialCode, string productGroup, string sourceSystem, int versionNo, string productName)
        {
