...
using SCG.CHEM.MBR.MASTER.API.Swagger;
using SCG.CHEM.SSPLSP.DATAACCESS;
using Swashbuckle.AspNetCore.Swagger;
using Swashbuckle.AspNetCore.SwaggerUI;

namespace SCG.CHEM.MBR.MASTER.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            GlobalDiagnosticsContext.Set("connectionString", Configuration.GetConnectionString("EntitiesMBRContext"));
