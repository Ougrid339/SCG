...
{
    public class ViewLSPMarketPriceRepo : RepositoryBase<vSSP_INF_LSP_MARKET_PRICE>, IViewLSPMarketPriceRepo, IDownloadAccountReportRepo
    {
        #region Inject

        public ViewLSPMarketPriceRepo(EntitiesContext context, EntitiesReadContext readConext) : base(context, readConext)
        {
        }
        ...
        {
            var query = _context.vSSP_INF_LSP_MARKET_PRICEs.AsQueryable();
            //if (startdate != null)
            //{
