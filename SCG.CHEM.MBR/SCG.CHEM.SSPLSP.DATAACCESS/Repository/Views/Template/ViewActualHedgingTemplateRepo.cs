...
{
    public class ViewActualHedgingTemplateRepo : RepositoryBase<vSSP_MST_ACTUAL_HEDGING_TEMPLATE>, IViewActualHedgingTemplateRepo, IDownloadRepo
    {
        #region Inject

        public ViewActualHedgingTemplateRepo(EntitiesContext context, EntitiesReadContext readConext) : base(context, readConext)
        {
        }
        ...
        {
            var query = _context.vSSP_MST_ACTUAL_HEDGING_TEMPLATEs.AsQueryable();
            if (startdate != null)
            {
