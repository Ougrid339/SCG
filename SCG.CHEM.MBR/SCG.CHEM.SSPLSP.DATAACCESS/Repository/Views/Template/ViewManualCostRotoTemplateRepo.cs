...
{
    public class ViewManualCostRotoTemplateRepo : RepositoryBase<vSSP_MST_MANUAL_COST_ROTO_TEMPLATE>, IViewManualCostRotoTemplateRepo, IDownloadRepo
    {
        #region Inject

        public ViewManualCostRotoTemplateRepo(EntitiesContext context, EntitiesReadContext readConext) : base(context, readConext)
        {
        }
        ...
        {
            var query = _context.vSSP_MST_MANUAL_COST_ROTO_TEMPLATEs.AsQueryable();
            if (startdate != null)
            {
