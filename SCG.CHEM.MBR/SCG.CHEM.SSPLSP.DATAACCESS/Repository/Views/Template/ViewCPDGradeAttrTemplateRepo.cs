...
{
    public class ViewCPDGradeAttrTemplateRepo : RepositoryBase<vSSP_MST_CPD_GRADE_ATTR_TEMPLATE>, IViewCPDGradeAttrTemplateRepo, IDownloadRepo
    {
        #region Inject

        public ViewCPDGradeAttrTemplateRepo(EntitiesContext context, EntitiesReadContext readConext) : base(context, readConext)
        {
        }
        ...
        {
            var query = _context.vSSP_MST_CPD_GRADE_ATTR_TEMPLATEs.AsQueryable();
            if (startdate != null)
            {
