...
{
    public class ViewAFPStandardEarnTemplateRepo : RepositoryBase<vSSP_MST_AFP_STANDARD_EARN_TEMPLATE>, IViewAFPStandardEarnTemplateRepo, IDownloadRepo
    {
        #region Inject

        public ViewAFPStandardEarnTemplateRepo(EntitiesContext context, EntitiesReadContext readConext) : base(context, readConext)
        {
        }
        ...
        {
            var query = _context.vSSP_MST_AFP_STANDARD_EARN_TEMPLATEs.AsQueryable();
            if (startdate != null)
            {
