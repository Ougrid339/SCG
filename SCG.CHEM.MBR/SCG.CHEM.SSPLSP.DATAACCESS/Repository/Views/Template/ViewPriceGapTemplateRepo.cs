...
{
    public class ViewPriceGapTemplateRepo : RepositoryBase<vSSP_MST_PRICE_GAP_TEMPLATE>, IViewPriceGapTemplateRepo, IDownloadRepo
    {
        #region Inject

        public ViewPriceGapTemplateRepo(EntitiesContext context, EntitiesReadContext readConext) : base(context, readConext)
        {
        }
        ...
        {
            var query = _context.vSSP_MST_PRICE_GAP_TEMPLATEs.AsQueryable();
            if (startdate != null)
            {
