...
{
    public class ViewRawMatGapTemplateRepo : RepositoryBase<vSSP_MST_RAW_MAT_GAP_TEMPLATE>, IViewRawMatGapTemplateRepo, IDownloadRepo
    {
        #region Inject

        public ViewRawMatGapTemplateRepo(EntitiesContext context, EntitiesReadContext readConext) : base(context, readConext)
        {
        }
        ...
        {
            var query = _context.vSSP_MST_RAW_MAT_GAP_TEMPLATEs.AsQueryable();
            if (startdate != null)
            {
