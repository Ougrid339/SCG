...
{
    public class ViewOperationChargeTemplateRepo : RepositoryBase<vSSP_MST_OPERATION_CHARGE_TEMPLATE>, IViewOperationChargeTemplateRepo, IDownloadRepo
    {
        #region Inject

        public ViewOperationChargeTemplateRepo(EntitiesContext context, EntitiesReadContext readConext) : base(context, readConext)
        {
        }
        ...
        {
            var query = _context.vSSP_MST_OPERATION_CHARGE_TEMPLATEs.AsQueryable();
            if (startdate != null)
            {
