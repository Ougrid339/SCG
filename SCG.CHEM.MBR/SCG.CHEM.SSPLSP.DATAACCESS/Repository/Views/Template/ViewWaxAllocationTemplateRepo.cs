...
{
    internal class ViewWaxAllocationTemplateRepo : RepositoryBase<vSSP_MST_WAX_ALLOCATION_TEMPLATE>, IViewWaxAllocationTemplateRepo, IDownloadRepo
    {
        #region Inject

        public ViewWaxAllocationTemplateRepo(EntitiesContext context, EntitiesReadContext readConext) : base(context, readConext)
        {
        }
        ...
        {
            var query = _context.vSSP_MST_WAX_ALLOCATION_TEMPLATEs.AsQueryable();
            if (startdate != null)
            {
