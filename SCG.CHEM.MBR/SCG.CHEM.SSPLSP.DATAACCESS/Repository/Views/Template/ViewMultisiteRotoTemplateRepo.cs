...
{
    public class ViewMultisiteRotoTemplateRepo : RepositoryBase<vSSP_MST_MULTISITE_ROTO_TEMPLATE>, IViewMultisiteRotoTemplateRepo, IDownloadRepo
    {
        #region Inject

        public ViewMultisiteRotoTemplateRepo(EntitiesContext context, EntitiesReadContext readConext) : base(context, readConext)
        {
        }
        ...
        {
            var query = _context.vSSP_MST_MULTISITE_ROTO_TEMPLATEs.AsQueryable();
            if (startdate != null)
            {
