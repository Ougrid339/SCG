...
{
    public class ViewFreightSubRegionTemplateRepo : RepositoryBase<vSSP_MST_FREIGHT_SUBREGION_TEMPLATE>, IViewFreightSubRegionTemplateRepo, IDownloadRepo
    {
        #region Inject

        public ViewFreightSubRegionTemplateRepo(EntitiesContext context, EntitiesReadContext readConext) : base(context, readConext)
        {
        }
        ...
        {
            var query = _context.vSSP_MST_FREIGHT_SUBREGION_TEMPLATEs.AsQueryable();
            if (startdate != null)
            {
