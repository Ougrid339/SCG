...
{
    public class ViewImportRMRotoTemplateRepo : RepositoryBase<vSSP_MST_IMPORT_RM_ROTO_TEMPLATE>, IViewImportRMRotoTemplateRepo, IDownloadRepo
    {
        #region Inject

        public ViewImportRMRotoTemplateRepo(EntitiesContext context, EntitiesReadContext readConext) : base(context, readConext)
        {
        }
        ...
        {
            var query = _context.vSSP_MST_IMPORT_RM_ROTO_TEMPLATEs.AsQueryable();
            //if (startdate != null)
            //{
