...
{
    public class ViewRMRollingTemplateRepo : RepositoryBase<vSSP_MST_RM_ROLLING_TEMPLATE>, IViewRMRollingTemplateRepo, IDownloadRepo
    {
        #region Inject

        public ViewRMRollingTemplateRepo(EntitiesContext context, EntitiesReadContext readConext) : base(context, readConext)
        {
        }
        ...
        {
            var query = _context.vSSP_MST_RM_ROLLING_TEMPLATEs.AsQueryable();
            //if (startdate != null)
            //{
