...
{
    public class ViewDeliveryByZoneTemplateRepo : RepositoryBase<vSSP_MST_DELIVERY_BY_ZONE_TEMPLATE>, IViewDeliveryByZoneTemplateRepo, IDownloadRepo
    {
        #region Inject

        public ViewDeliveryByZoneTemplateRepo(EntitiesContext context, EntitiesReadContext readConext) : base(context, readConext)
        {
        }
        ...
        {
            var query = _context.vSSP_MST_DELIVERY_BY_ZONE_TEMPLATEs.AsQueryable();
            if (startdate != null)
            {
