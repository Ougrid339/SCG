...
{
    public class ViewOtherCostTemplateRepo : RepositoryBase<vSSP_MST_OTHER_COST_TEMPLATE>, IViewOtherCostTemplateRepo, IDownloadRepo
    {
        #region Inject

        public ViewOtherCostTemplateRepo(EntitiesContext context, EntitiesReadContext readConext) : base(context, readConext)
        {
        }
        ...
        {
            var query = _context.vSSP_MST_OTHER_COST_TEMPLATEs.AsQueryable();
            if (startdate != null)
            {
