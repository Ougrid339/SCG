...
{
    public class ViewStandardLineTemplateRepo : RepositoryBase<vSSP_MST_STANDARD_LINE_TEMPLATE>, IViewStandardLineTemplateRepo, IDownloadRepo
    {
        #region Inject

        public ViewStandardLineTemplateRepo(EntitiesContext context, EntitiesReadContext readConext) : base(context, readConext)
        {
        }
        ...
        {
            var query = _context.vSSP_MST_STANDARD_LINE_TEMPLATEs.AsQueryable();
            //if (startdate != null)
            //{
