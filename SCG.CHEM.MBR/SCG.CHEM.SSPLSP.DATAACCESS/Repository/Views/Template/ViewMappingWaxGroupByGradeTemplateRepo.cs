...
{
    public class ViewMappingWaxGroupByGradeTemplateRepo : RepositoryBase<vSSP_MST_MAPPING_WAX_GROUP_BY_GRADE_TEMPLATE>, IViewMappingWaxGroupByGradeTemplateRepo, IDownloadRepo
    {
        #region Inject

        public ViewMappingWaxGroupByGradeTemplateRepo(EntitiesContext context, EntitiesReadContext readConext) : base(context, readConext)
        {
        }
        ...
        {
            var query = _context.vSSP_MST_MAPPING_WAX_GROUP_BY_GRADE_TEMPLATEs.AsQueryable();
            //if (startdate != null)
            //{
