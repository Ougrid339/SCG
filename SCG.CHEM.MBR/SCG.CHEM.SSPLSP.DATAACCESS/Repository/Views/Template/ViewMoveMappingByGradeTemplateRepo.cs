...
{
    public class ViewMoveMappingByGradeTemplateRepo : RepositoryBase<vSSP_MST_MOVE_MAPPING_BY_GRADE_TEMPLATE>, IViewMoveMappingByGradeTemplateRepo, IDownloadRepo
    {
        #region Inject

        public ViewMoveMappingByGradeTemplateRepo(EntitiesContext context, EntitiesReadContext readConext) : base(context, readConext)
        {
        }
        ...
        {
            var query = _context.vSSP_MST_MOVE_MAPPING_BY_GRADE_TEMPLATEs.AsQueryable();
            //if (startdate != null)
            //{
