...
{
    public class ViewDeliveryCostTemplateRepo : RepositoryBase<vSSP_MST_DELIVERY_COST_TEMPLATE>, IViewDeliveryCostTemplateRepo, IDownloadRepo
    {
        #region Inject

        public ViewDeliveryCostTemplateRepo(EntitiesContext context, EntitiesReadContext readConext) : base(context, readConext)
        {
        }
        ...
        {
            var query = _context.vSSP_MST_DELIVERY_COST_TEMPLATEs.AsQueryable();
            if (startdate != null)
            {
