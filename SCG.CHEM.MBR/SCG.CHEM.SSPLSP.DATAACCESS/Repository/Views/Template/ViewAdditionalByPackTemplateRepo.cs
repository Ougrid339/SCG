...
{
    public class ViewAdditionalByPackTemplateRepo : RepositoryBase<vSSP_MST_ADDITIONAL_BY_PACK_TEMPLATE>, IViewAdditionalByPackTemplateRepo, IDownloadRepo
    {
        #region Inject

        public ViewAdditionalByPackTemplateRepo(EntitiesContext context, EntitiesReadContext readConext) : base(context, readConext)
        {
        }
        ...
        {
            var query = _context.vSSP_MST_ADDITIONAL_BY_PACK_TEMPLATEs.AsQueryable();
            if (startdate != null)
            {
