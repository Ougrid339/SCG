...
{
    public class ViewMarketPriceGapTemplateRepo : RepositoryBase<vSSP_MST_MARKET_PRICE_GAP_TEMPLATE>, IViewMarketPriceGapTemplateRepo, IDownloadRepo
    {
        #region Inject

        public ViewMarketPriceGapTemplateRepo(EntitiesContext context, EntitiesReadContext readConext) : base(context, readConext)
        {
        }
        ...
        {
            var query = _context.vSSP_MST_MARKET_PRICE_GAP_TEMPLATEs.AsQueryable();
            if (startdate != null)
            {
