...
{
    public class ViewManualCostRotoExportRepo : RepositoryBase<vSSP_MST_MANUAL_COST_ROTO_EXPORT>, IViewManualCostRotoExportRepo, IDownloadRepo
    {
        #region Inject

        public ViewManualCostRotoExportRepo(EntitiesContext context, EntitiesReadContext readConext) : base(context, readConext)
        {
        }
        ...
        {
            var query = _context.vSSP_MST_MANUAL_COST_ROTO_EXPORTs.AsQueryable();
            if (startdate != null)
            {
