...
{
    public class ViewPolymerPriceExportRepo : RepositoryBase<vSSP_MST_POLYMER_PRICE_EXPORT>, IViewPolymerPriceExportRepo, IDownloadRepo
    {
        #region Inject

        public ViewPolymerPriceExportRepo(EntitiesContext context, EntitiesReadContext readConext) : base(context, readConext)
        {
        }
        ...
        {
            var query = _context.vSSP_MST_POLYMER_PRICE_EXPORTs.AsQueryable();
            //if (startdate != null)
            //{
