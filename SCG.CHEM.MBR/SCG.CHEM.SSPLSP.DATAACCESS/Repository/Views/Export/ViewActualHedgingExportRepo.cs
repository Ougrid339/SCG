...
{
    public class ViewActualHedgingExportRepo : RepositoryBase<vSSP_MST_ACTUAL_HEDGING_EXPORT>, IViewActualHedgingExportRepo, IDownloadRepo
    {
        #region Inject

        public ViewActualHedgingExportRepo(EntitiesContext context, EntitiesReadContext readConext) : base(context, readConext)
        {
        }
        ...
        {
            var query = _context.vSSP_MST_ACTUAL_HEDGING_EXPORTs.AsQueryable();
            if (startdate != null)
            {
