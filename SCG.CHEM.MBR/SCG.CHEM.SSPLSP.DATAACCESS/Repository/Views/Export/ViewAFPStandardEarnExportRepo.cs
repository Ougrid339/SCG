...
{
    public class ViewAFPStandardEarnExportRepo : RepositoryBase<vSSP_MST_AFP_STANDARD_EARN_EXPORT>, IViewAFPStandardEarnExportRepo, IDownloadRepo
    {
        #region Inject

        public ViewAFPStandardEarnExportRepo(EntitiesContext context, EntitiesReadContext readConext) : base(context, readConext)
        {
        }
        ...
        {
            var query = _context.vSSP_MST_AFP_STANDARD_EARN_EXPORTs.AsQueryable();
            if (startdate != null)
            {
