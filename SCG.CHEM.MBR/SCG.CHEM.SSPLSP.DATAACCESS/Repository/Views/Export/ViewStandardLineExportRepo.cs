...
{
    public class ViewStandardLineExportRepo : RepositoryBase<vSSP_MST_STANDARD_LINE_EXPORT>, IViewStandardLineExportRepo, IDownloadRepo
    {
        #region Inject

        public ViewStandardLineExportRepo(EntitiesContext context, EntitiesReadContext readConext) : base(context, readConext)
        {
        }
        ...
        {
            var query = _context.vSSP_MST_STANDARD_LINE_EXPORTs.AsQueryable();
            //if (startdate != null)
            //{
