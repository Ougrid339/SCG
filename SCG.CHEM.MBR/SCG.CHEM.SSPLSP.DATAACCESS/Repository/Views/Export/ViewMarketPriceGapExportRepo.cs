...
{
    public class ViewMarketPriceGapExportRepo : RepositoryBase<vSSP_MST_MARKET_PRICE_GAP_EXPORT>, IViewMarketPriceGapExportRepo, IDownloadRepo
    {
        #region Inject

        public ViewMarketPriceGapExportRepo(EntitiesContext context, EntitiesReadContext readConext) : base(context, readConext)
        {
        }
        ...
        {
            var query = _context.vSSP_MST_MARKET_PRICE_GAP_EXPORTs.AsQueryable();
            if (startdate != null)
            {
