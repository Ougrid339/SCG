...
{
    public class ViewCPDGradeAttrExportRepo : RepositoryBase<vSSP_MST_CPD_GRADE_ATTR_EXPORT>, IViewCPDGradeAttrExportRepo, IDownloadRepo
    {
        #region Inject

        public ViewCPDGradeAttrExportRepo(EntitiesContext context, EntitiesReadContext readConext) : base(context, readConext)
        {
        }
        ...
        {
            var query = _context.vSSP_MST_CPD_GRADE_ATTR_EXPORTs.AsQueryable();
            if (startdate != null)
            {
