...
{
    public class ViewWaxAllocationExportRepo : RepositoryBase<vSSP_MST_WAX_ALLOCATION_EXPORT>, IViewWaxAllocationExportRepo, IDownloadRepo
    {
        #region Inject

        public ViewWaxAllocationExportRepo(EntitiesContext context, EntitiesReadContext readConext) : base(context, readConext)
        {
        }
        ...
        {
            var query = _context.vSSP_MST_WAX_ALLOCATION_EXPORTs.AsQueryable();
            if (startdate != null)
            {
