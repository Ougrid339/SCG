...
{
    public class ViewDeliveryCostFlagExportRepo : RepositoryBase<vSSP_MST_DELIVERY_COST_FLAG_EXPORT>, IViewDeliveryCostFlagExportRepo, IDownloadRepo
    {
        #region Inject

        public ViewDeliveryCostFlagExportRepo(EntitiesContext context, EntitiesReadContext readConext) : base(context, readConext)
        {
        }
        ...
        {
            var query = _context.vSSP_MST_DELIVERY_COST_FLAG_EXPORTs.AsQueryable();
            if (startdate != null)
            {
