...
{
    public class ViewPriceGapExportRepo : RepositoryBase<vSSP_MST_PRICE_GAP_EXPORT>, IViewPriceGapExportRepo, IDownloadRepo
    {
        #region Inject

        public ViewPriceGapExportRepo(EntitiesContext context, EntitiesReadContext readConext) : base(context, readConext)
        {
        }
        ...
        {
            var query = _context.vSSP_MST_PRICE_GAP_EXPORTs.AsQueryable();
            if (startdate != null)
            {
