...
{
    public class ViewImportRMRotoExportRepo : RepositoryBase<vSSP_MST_IMPORT_RM_ROTO_EXPORT>, IViewImportRMRotoExportRepo, IDownloadRepo
    {
        #region Inject

        public ViewImportRMRotoExportRepo(EntitiesContext context, EntitiesReadContext readConext) : base(context, readConext)
        {
        }
        ...
        {
            var query = _context.vSSP_MST_IMPORT_RM_ROTO_EXPORTs.AsQueryable();
            //if (startdate != null)
            //{
