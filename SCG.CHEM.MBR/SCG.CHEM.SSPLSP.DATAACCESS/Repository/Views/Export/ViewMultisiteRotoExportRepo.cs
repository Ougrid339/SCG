...
{
    public class ViewMultisiteRotoExportRepo : RepositoryBase<vSSP_MST_MULTISITE_ROTO_EXPORT>, IViewMultisiteRotoExportRepo, IDownloadRepo
    {
        #region Inject

        public ViewMultisiteRotoExportRepo(EntitiesContext context, EntitiesReadContext readConext) : base(context, readConext)
        {
        }
        ...
        {
            var query = _context.vSSP_MST_MULTISITE_ROTO_EXPORTs.AsQueryable();
            if (startdate != null)
            {
