...
{
    public class ViewDeliveryByZoneExportRepo : RepositoryBase<vSSP_MST_DELIVERY_BY_ZONE_EXPORT>, IViewDeliveryByZoneExportRepo, IDownloadRepo
    {
        #region Inject

        public ViewDeliveryByZoneExportRepo(EntitiesContext context, EntitiesReadContext readConext) : base(context, readConext)
        {
        }
        ...
        {
            var query = _context.vSSP_MST_DELIVERY_BY_ZONE_EXPORTs.AsQueryable();
            if (startdate != null)
            {
