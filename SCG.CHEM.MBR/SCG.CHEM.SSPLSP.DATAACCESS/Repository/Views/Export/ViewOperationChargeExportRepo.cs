...
{
    public class ViewOperationChargeExportRepo : RepositoryBase<vSSP_MST_OPERATION_CHARGE_EXPORT>, IViewOperationChargeExportRepo, IDownloadRepo
    {
        #region Inject

        public ViewOperationChargeExportRepo(EntitiesContext context, EntitiesReadContext readConext) : base(context, readConext)
        {
        }
        ...
        {
            var query = _context.vSSP_MST_OPERATION_CHARGE_EXPORTs.AsQueryable();
            if (startdate != null)
            {
