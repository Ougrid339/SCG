...
{
    public class ViewMoveMappingByGradeExportRepo : RepositoryBase<vSSP_MST_MOVE_MAPPING_BY_GRADE_EXPORT>, IViewMoveMappingByGradeExportRepo, IDownloadRepo
    {
        #region Inject

        public ViewMoveMappingByGradeExportRepo(EntitiesContext context, EntitiesReadContext readConext) : base(context, readConext)
        {
        }
        ...
        {
            var query = _context.vSSP_MST_MOVE_MAPPING_BY_GRADE_EXPORTs.AsQueryable();
            //if (startdate != null)
            //{
