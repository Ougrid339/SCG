...
{
    public class ViewWaxViscosityPercentExportRepo : RepositoryBase<vSSP_MST_WAX_VISCOSITY_PERCENT_EXPORT>, IViewWaxViscosityPercentExportRepo, IDownloadRepo
    {
        #region Inject

        public ViewWaxViscosityPercentExportRepo(EntitiesContext context, EntitiesReadContext readConext) : base(context, readConext)
        {
        }
        ...
        {
            var query = _context.vSSP_MST_WAX_VISCOSITY_PERCENT_EXPORTs.AsQueryable();
            if (startdate != null)
            {
