...
{
    [Table("SSP_TMP_MappingWaxGroupByGrade")]
    public class SSP_TMP_MAPPING_WAX_GROUP_BY_GRADE
    {
        [Key]
        [StringLength(10)]
        ...
        public SSP_TMP_MAPPING_WAX_GROUP_BY_GRADE()
        { }

        public SSP_TMP_MAPPING_WAX_GROUP_BY_GRADE(SSP_MST_MAPPING_WAX_GROUP_BY_GRADE data)
        {
        ...
        public SSP_TMP_MAPPING_WAX_GROUP_BY_GRADE(string grade, string waxGroup, string polymerMKT, string monomerMKT, int versionNo)
        {
            Grade = grade;
            WaxGroup = waxGroup;
