...
{
    [Table("SSP_TMP_OtherCost")]
    public class SSP_TMP_OTHER_COST : BaseDatabaseContext
    {
        [Key]
        [StringLength(10)]
        ...
        public SSP_TMP_OTHER_COST()
        { }

        public SSP_TMP_OTHER_COST(SSP_MST_OTHER_COST data)
        {
        ...
        public SSP_TMP_OTHER_COST(string planType, decimal payment, int paymentUnit, decimal upfront, int upfrontUnit, decimal kickback, int kickbackUnit, decimal insurance, int insuranceUnit, decimal taxRefund, int taxRefundUnit, string channel, string salesOrg, string startMonth, int versionNo)
        {
            PlanType = planType;
            Payment = payment;
