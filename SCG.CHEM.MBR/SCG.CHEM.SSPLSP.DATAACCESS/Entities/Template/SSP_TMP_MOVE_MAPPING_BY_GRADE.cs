...
{
    [Table("SSP_TMP_MoveMappingByGrade")]
    public class SSP_TMP_MOVE_MAPPING_BY_GRADE
    {
        [Key]
        [StringLength(2)]
        ...
        public SSP_TMP_MOVE_MAPPING_BY_GRADE()
        { }

        public SSP_TMP_MOVE_MAPPING_BY_GRADE(SSP_MST_MOVE_MAPPING_BY_GRADE data)
        {
        ...
        public SSP_TMP_MOVE_MAPPING_BY_GRADE(string productionSite, string stockType, string grade, string productSub, int versionNo)
        {
