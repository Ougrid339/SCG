...
{
    [Table("SSP_TMP_AdditionalByGradePack")]
    public class SSP_TMP_ADDITIONAL_BY_GRADEPACK : BaseDatabaseContext
    {
        [Key]
        [StringLength(2)]
        ...
        public SSP_TMP_ADDITIONAL_BY_GRADEPACK()
        { }

        public SSP_TMP_ADDITIONAL_BY_GRADEPACK(SSP_MST_ADDITIONAL_BY_GRADEPACK data)
        {
        ...
        public SSP_TMP_ADDITIONAL_BY_GRADEPACK(string productionSite, string planType, string matPrefix, string grade, string package, string channelGroup, int unitId, decimal deliveryCostByGrade, decimal packageCostByGrade, string startMonth, int versionNo)
        {
