...
{
    [Table("SSP_TMP_MonomerExportExpense")]
    public class SSP_TMP_MONOMER_EXPORT_EXPENSE : BaseDatabaseContext
    {
        [Key]
        [StringLength(2)]
        ...
        public SSP_TMP_MONOMER_EXPORT_EXPENSE()
        { }

        public SSP_TMP_MONOMER_EXPORT_EXPENSE(SSP_MST_MONOMER_EXPORT_EXPENSE data)
        {
        ...
        public SSP_TMP_MONOMER_EXPORT_EXPENSE(string productionSite, string planType, string matPrefix, string product, string productSub, int unitId, decimal exportExpense, decimal? percentShared, string startMonth, int versionNo)
        {
