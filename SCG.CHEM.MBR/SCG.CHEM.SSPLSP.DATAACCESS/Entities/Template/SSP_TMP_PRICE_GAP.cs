...
{
    [Table("SSP_TMP_PriceGap")]
    public class SSP_TMP_PRICE_GAP : BaseDatabaseContext
    {
        [Key]
        [StringLength(10)]
        ...
        public SSP_TMP_PRICE_GAP()
        { }

        public SSP_TMP_PRICE_GAP(SSP_MST_PRICE_GAP data)
        {
        ...
        public SSP_TMP_PRICE_GAP(string planType, string rawMatCode, string marketGroup, int unitId, decimal? priceGap, string startMonth, int versionNo)
        {
            PlanType = planType;
