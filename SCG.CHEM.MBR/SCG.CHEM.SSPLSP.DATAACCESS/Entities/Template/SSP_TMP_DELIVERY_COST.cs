...
{
    [Table("SSP_TMP_DeliveryCost")]
    public class SSP_TMP_DELIVERY_COST : BaseDatabaseContext
    {
        [Key]
        [StringLength(2)]
        ...
        public SSP_TMP_DELIVERY_COST()
        { }

        public SSP_TMP_DELIVERY_COST(SSP_MST_DELIVERY_COST data)
        {
        ...
        public SSP_TMP_DELIVERY_COST(string productionSite, string planType, string matPrefix, string product, string productSub, string channelGroup, int unitId, decimal delivery, decimal baseDelivery, string startMonth, int versionNo)
        {
