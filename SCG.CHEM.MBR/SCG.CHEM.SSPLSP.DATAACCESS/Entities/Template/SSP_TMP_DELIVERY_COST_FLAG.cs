...
{
    [Table("SSP_TMP_DeliveryCostFlag")]
    public class SSP_TMP_DELIVERY_COST_FLAG : BaseDatabaseContext
    {
        [Key]
        [StringLength(2)]
        ...
        public SSP_TMP_DELIVERY_COST_FLAG()
        { }

        public SSP_TMP_DELIVERY_COST_FLAG(SSP_MST_DELIVERY_COST_FLAG data)
        {
        ...
        public SSP_TMP_DELIVERY_COST_FLAG(string productionSite, string planType, string matPrefix, string product, string productSub, string channelGroup, string deliveryMethod, string deliveryFlag, string startMonth, int versionNo)
        {
