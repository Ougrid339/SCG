...
{
    [Table("SSP_TMP_TariffDestinationDeliveryCost")]
    public class SSP_TMP_TARIFF_DESTINATION_DELIVERY_COST : BaseDatabaseContext
    {
        [Key]
        [StringLength(10)]
        ...
        public SSP_TMP_TARIFF_DESTINATION_DELIVERY_COST()
        { }

        public SSP_TMP_TARIFF_DESTINATION_DELIVERY_COST(SSP_MST_TARIFF_DESTINATION_DELIVERY_COST data)
        {
        ...
        public SSP_TMP_TARIFF_DESTINATION_DELIVERY_COST(string planType, string productionSite, string region, decimal tariffCost, decimal aDTCost, string product, string productSub, string startMonth, int versionNo)
        {
            PlanType = planType;
