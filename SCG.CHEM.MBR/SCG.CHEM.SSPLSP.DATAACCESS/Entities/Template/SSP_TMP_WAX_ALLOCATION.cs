...
{
    [Table("SSP_TMP_WaxAllocation")]
    public class SSP_TMP_WAX_ALLOCATION : BaseDatabaseContext
    {
        [Key]
        [StringLength(10)]
        ...
        public SSP_TMP_WAX_ALLOCATION()
        { }

        public SSP_TMP_WAX_ALLOCATION(SSP_MST_WAX_ALLOCATION data)
        {
        ...
        public SSP_TMP_WAX_ALLOCATION(string planType, string waxGroupId, string fromProductionLine, string toProductionLine, decimal percentAllocation, string startMonth, int versionNo)
        {
            PlanType = planType;
