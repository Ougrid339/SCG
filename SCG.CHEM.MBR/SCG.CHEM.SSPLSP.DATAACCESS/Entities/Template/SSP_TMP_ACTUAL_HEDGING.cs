...
{
    [Table("SSP_TMP_ActualHedging")]
    public class SSP_TMP_ACTUAL_HEDGING : BaseDatabaseContext
    {
        [Key]
        [StringLength(10)]
        ...
        public SSP_TMP_ACTUAL_HEDGING()
        { }

        public SSP_TMP_ACTUAL_HEDGING(SSP_MST_ACTUAL_HEDGING data)
        {
        ...
        public SSP_TMP_ACTUAL_HEDGING(string planType, string productionSite, string customer, string salesGroup, string matCode, int unitId, decimal hedgeSalesPrice, string startMonth, int versionNo)
        {
            PlanType = planType;
