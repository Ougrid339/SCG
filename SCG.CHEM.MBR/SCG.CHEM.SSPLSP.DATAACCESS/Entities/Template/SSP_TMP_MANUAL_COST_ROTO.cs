...
{
    [Table("SSP_TMP_ManualCostRoto")]
    public class SSP_TMP_MANUAL_COST_ROTO : BaseDatabaseContext
    {
        [Key]
        [StringLength(10)]
        ...
        public SSP_TMP_MANUAL_COST_ROTO()
        { }

        public SSP_TMP_MANUAL_COST_ROTO(SSP_MST_MANUAL_COST_ROTO data)
        {
