...
{
    [Table("SSP_TMP_OperationCharge")]
    public class SSP_TMP_OPERATION_CHARGE : BaseDatabaseContext
    {
        [Key]
        [StringLength(10)]
        ...
        public SSP_TMP_OPERATION_CHARGE()
        { }

        public SSP_TMP_OPERATION_CHARGE(SSP_MST_OPERATION_CHARGE data)
        {
        ...
        public SSP_TMP_OPERATION_CHARGE(string planType, string product, string productSub, string channelCode, decimal discount, int discountUnitId,
