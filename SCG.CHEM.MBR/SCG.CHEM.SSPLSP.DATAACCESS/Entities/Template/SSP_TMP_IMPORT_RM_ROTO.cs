...
{
    [Table("SSP_TMP_ImportRMRoto")]
    public class SSP_TMP_IMPORT_RM_ROTO : BaseDatabaseContext
    {
        [Key]
        [StringLength(20)]
        ...
        public SSP_TMP_IMPORT_RM_ROTO()
        { }

        public SSP_TMP_IMPORT_RM_ROTO(SSP_MST_IMPORT_RM_ROTO data)
        {
        ...
        public SSP_TMP_IMPORT_RM_ROTO(string rawMatCode, string rawMatDesc, string refRawMatCode, int versionNo)
        {
