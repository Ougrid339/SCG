...
{
    [Table("SSP_TMP_CPDGradeAttr")]
    public class SSP_TMP_CPD_GRADE_ATTR : BaseDatabaseContext
    {
        [Key]
        [StringLength(2)]
        ...
        public SSP_TMP_CPD_GRADE_ATTR()
        { }

        public SSP_TMP_CPD_GRADE_ATTR(SSP_MST_CPD_GRADE_ATTR data)
        {
        ...
        public SSP_TMP_CPD_GRADE_ATTR(string productionSite, string matPrefix, string grade, string mainGrade, string mTSFlag, string formula, string cPDApplication, string cPDGroup, string sTDPlant, string sTDProductionLine, string sTDPackage, string startMonth, int versionNo)
        {
