...
{
    [Table("SSP_TMP_RMRolling")]
    public class SSP_TMP_RM_ROLLING
    {
        [Key]
        [StringLength(10)]
        ...
        public SSP_TMP_RM_ROLLING()
        { }

        public SSP_TMP_RM_ROLLING(SSP_MST_RM_ROLLING data)
        {
        ...
        public SSP_TMP_RM_ROLLING(string planType, string inputM1, string versionName, string companyCode, string matCode, string matName, string dataPart, string unitId, string monthNo, string monthIndex, decimal price, decimal qty, int versionNo)
        {
            PlanType = planType;
            InputM1 = inputM1;
