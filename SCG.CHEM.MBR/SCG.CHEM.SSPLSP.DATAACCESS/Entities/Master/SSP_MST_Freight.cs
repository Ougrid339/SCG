...
{
    [Table("SSP_MST_Freight")]
    public class SSP_MST_FREIGHT : BaseDatabaseContext
    {
        [Key]
        [StringLength(2)]
        ...
        public SSP_MST_FREIGHT()
        { }

        public SSP_MST_FREIGHT(SSP_TMP_FREIGHT data)
        {
        ...
        public SSP_MST_FREIGHT(string productionSite, string regionCode, int unitId, decimal stdFreight, string planType, decimal freightAmtAdjTPE, decimal freightAmtAdjLSP, string startMonth, int versionNo)
        {
