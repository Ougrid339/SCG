...
{
    [Table("SSP_MST_ManualAdjustCostGradeLine")]
    public class SSP_MST_MANUAL_ADJUST_COST_GRADELINE : BaseDatabaseContext
    {
        [Key]
        [StringLength(2)]
        ...
        public SSP_MST_MANUAL_ADJUST_COST_GRADELINE()
        { }

        public SSP_MST_MANUAL_ADJUST_COST_GRADELINE(SSP_TMP_MANUAL_ADJUST_COST_GRADELINE data)
        {
        ...
        public SSP_MST_MANUAL_ADJUST_COST_GRADELINE(string productionSite, string planType, string matPrefix, string grade,
