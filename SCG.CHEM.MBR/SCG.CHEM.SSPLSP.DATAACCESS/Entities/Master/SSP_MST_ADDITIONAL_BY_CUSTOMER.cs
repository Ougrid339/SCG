...
{
    [Table("SSP_MST_AdditionalByCustomer")]
    public class SSP_MST_ADDITIONAL_BY_CUSTOMER : BaseDatabaseContext
    {
        [Key]
        [StringLength(2)]
        ...
        public SSP_MST_ADDITIONAL_BY_CUSTOMER()
        { }

        public SSP_MST_ADDITIONAL_BY_CUSTOMER(SSP_TMP_ADDITIONAL_BY_CUSTOMER data)
        {
        ...
        public SSP_MST_ADDITIONAL_BY_CUSTOMER(string productionSite, string planType, string matPrefix, string product, string productSub, string customer, int unitId, decimal deliveryByCustomer, decimal packageByCustomer, string startMonth, int versionNo)
        {
