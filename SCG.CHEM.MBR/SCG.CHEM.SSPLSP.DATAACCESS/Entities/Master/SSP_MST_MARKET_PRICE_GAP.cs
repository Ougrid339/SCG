...
{
    [Table("SSP_MST_MarketPriceGap")]
    public class SSP_MST_MARKET_PRICE_GAP : BaseDatabaseContext
    {
        [Key]
        [StringLength(2)]
        ...
        public SSP_MST_MARKET_PRICE_GAP()
        { }

        public SSP_MST_MARKET_PRICE_GAP(SSP_TMP_MARKET_PRICE_GAP data)
        {
        ...
        public SSP_MST_MARKET_PRICE_GAP(string productionSite, string planType, string baseMarketGroup, string marketGroup, int unitId, decimal marketGap, string startMonth, int versionNo)
        {
