...
{
    [Table("SSP_MST_MultisiteRoto")]
    public class SSP_MST_MULTISITE_ROTO : BaseDatabaseContext
    {
        [Key]
        [StringLength(10)]
        ...
        public SSP_MST_MULTISITE_ROTO()
        { }

        public SSP_MST_MULTISITE_ROTO(SSP_TMP_MULTISITE_ROTO data)
        {
        ...
        public SSP_MST_MULTISITE_ROTO(string planType, string valType, int unitId, decimal uSDMultiSiteMovement, string startMonth, int versionNo)
        {
            PlanType = planType;
            ValType = valType;
            UnitId = unitId;
