...
{
    [Table("SSP_MST_RawMatGap")]
    public class SSP_MST_RAW_MAT_GAP : BaseDatabaseContext
    {
        [Key]
        [StringLength(2)]
        ...
        public SSP_MST_RAW_MAT_GAP()
        { }

        public SSP_MST_RAW_MAT_GAP(SSP_TMP_RAW_MAT_GAP data)
        {
        ...
        public SSP_MST_RAW_MAT_GAP(string productionSite, string planType, string company, string matCode, int unitId, decimal? gapPrice, string startMonth, int versionNo)
        {
