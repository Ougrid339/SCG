...
{
    [Table("SSP_MST_WaxViscosityPercent")]
    public class SSP_MST_WAX_VISCOSITY_PERCENT : BaseDatabaseContext
    {
        [Key]
        [StringLength(10)]
        ...
        public SSP_MST_WAX_VISCOSITY_PERCENT()
        { }

        public SSP_MST_WAX_VISCOSITY_PERCENT(SSP_TMP_WAX_VISCOSITY_PERCENT data)
        {
        ...
        public SSP_MST_WAX_VISCOSITY_PERCENT(string planType, string matPrefix, string grade, string gradeComp, string plant, string productionLine, decimal lvPercent, decimal hvPercent, string startMonth, int versionNo)
        {
            PlanType = planType;
            MatPrefix = matPrefix;
            Grade = grade;
