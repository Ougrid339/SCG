...
{
    [Table("SSP_MST_StandardLine")]
    public class SSP_MST_STANDARD_LINE
    {
        [Key]
        [StringLength(2)]
        ...
        public SSP_MST_STANDARD_LINE()
        { }

        public SSP_MST_STANDARD_LINE(SSP_TMP_STANDARD_LINE data)
        {
        ...
        public SSP_MST_STANDARD_LINE(string productionSite, string matPrefix, string grade, string plant, string productionLine, decimal? ratio, int versionNo)
        {
