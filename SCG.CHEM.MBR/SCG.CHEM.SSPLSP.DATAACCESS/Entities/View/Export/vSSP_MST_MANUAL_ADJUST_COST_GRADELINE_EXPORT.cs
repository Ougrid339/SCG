...
{
    [Keyless]
    public class vSSP_MST_MANUAL_ADJUST_COST_GRADELINE_EXPORT
    {
        ...
        [Column(TypeName = "decimal(15, 5)")]
        public decimal AdjustedYieldVentGasC2 { get; set; }

        [Column(TypeName = "decimal(15, 5)")]
        public decimal AdjustedYieldVentGasC3 { get; set; }
        ...
        [Column(TypeName = "decimal(15, 5)")]
        public decimal? Adjusted3rdRM { get; set; }
