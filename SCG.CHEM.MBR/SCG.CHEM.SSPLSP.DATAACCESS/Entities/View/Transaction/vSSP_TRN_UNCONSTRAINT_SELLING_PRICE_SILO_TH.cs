...
{
    [Keyless]
    public class vSSP_TRN_UNCONSTRAINT_SELLING_PRICE_SILO_TH
    {
        ...
        public decimal? RefMarketPriceTH { get; set; }
        ...
        public int? TaxRefundUnitIdTH { get; set; }

        [Column(TypeName = "decimal(15, 5)")]
        public decimal? TaxRefundTH { get; set; }
